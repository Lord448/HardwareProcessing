...
-- Design Ports Information
-- i_FixedPoint[0]	=>  Location: PIN_64,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- i_FixedPoint[1]	=>  Location: PIN_115,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- i_FixedPoint[2]	=>  Location: PIN_31,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- i_FixedPoint[3]	=>  Location: PIN_111,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \DisplayDriver|LessThan0~2_combout\ = (!\DisplayDriver|r_Count\(11) & (!\DisplayDriver|r_Count\(14) & (!\DisplayDriver|r_Count\(12) & !\DisplayDriver|r_Count\(13))))
...
-- Equation(s):
-- \DisplayDriver|LessThan0~3_combout\ = (\DisplayDriver|r_Count\(15) & (\DisplayDriver|r_Count\(16) & ((!\DisplayDriver|LessThan0~1_combout\) # (!\DisplayDriver|LessThan0~2_combout\))))
...
PORT MAP (
	...
	datac => \DisplayDriver|LessThan0~2_combout\,
...
-- Equation(s):
-- \Mux1~0_combout\ = (\i_OpSel[0]~input_o\ & !\i_OpSel[1]~input_o\)
...
-- Equation(s):
-- \Add0~1_combout\ = (\Add0~0_combout\ & (\Mux1~0_combout\ $ (VCC))) # (!\Add0~0_combout\ & (\Mux1~0_combout\ & VCC))
-- \Add0~2\ = CARRY((\Add0~0_combout\ & \Mux1~0_combout\))
...
-- Equation(s):
-- \Add1~0_combout\ = (\Add0~1_combout\ & (\i_NumA[0]~input_o\ $ (VCC))) # (!\Add0~1_combout\ & (\i_NumA[0]~input_o\ & VCC))
-- \Add1~1\ = CARRY((\Add0~1_combout\ & \i_NumA[0]~input_o\))
...
-- Equation(s):
-- \Add1~23_combout\ = (\i_OpSel[1]~input_o\ & ((\Mult0|auto_generated|mac_out2~DATAOUT4\))) # (!\i_OpSel[1]~input_o\ & (\Add1~0_combout\))
...
-- Equation(s):
-- \Add0~3_combout\ = (\Add0~2\ & (\i_NumB[1]~input_o\ $ ((!\Mux1~0_combout\)))) # (!\Add0~2\ & ((\i_NumB[1]~input_o\ $ (\Mux1~0_combout\)) # (GND)))
-- \Add0~4\ = CARRY((\i_NumB[1]~input_o\ $ (!\Mux1~0_combout\)) # (!\Add0~2\))
...
-- Equation(s):
-- \Add0~5_combout\ = (\Add0~4\ & ((\i_NumB[2]~input_o\ $ (\Mux1~0_combout\)))) # (!\Add0~4\ & (\i_NumB[2]~input_o\ $ (\Mux1~0_combout\ $ (VCC))))
-- \Add0~6\ = CARRY((!\Add0~4\ & (\i_NumB[2]~input_o\ $ (\Mux1~0_combout\))))
...
-- Equation(s):
-- \Add1~2_combout\ = (\Add0~3_combout\ & ((\i_NumA[1]~input_o\ & (\Add1~1\ & VCC)) # (!\i_NumA[1]~input_o\ & (!\Add1~1\)))) # (!\Add0~3_combout\ & ((\i_NumA[1]~input_o\ & (!\Add1~1\)) # (!\i_NumA[1]~input_o\ & ((\Add1~1\) # (GND)))))
-- \Add1~3\ = CARRY((\Add0~3_combout\ & (!\i_NumA[1]~input_o\ & !\Add1~1\)) # (!\Add0~3_combout\ & ((!\Add1~1\) # (!\i_NumA[1]~input_o\))))
...
-- Equation(s):
-- \Add1~25_combout\ = (\i_OpSel[1]~input_o\ & ((\Mult0|auto_generated|mac_out2~DATAOUT6\))) # (!\i_OpSel[1]~input_o\ & (\Add1~4_combout\))
...
-- Equation(s):
-- \Add0~7_combout\ = (\Add0~6\ & (\i_NumB[3]~input_o\ $ ((!\Mux1~0_combout\)))) # (!\Add0~6\ & ((\i_NumB[3]~input_o\ $ (\Mux1~0_combout\)) # (GND)))
-- \Add0~8\ = CARRY((\i_NumB[3]~input_o\ $ (!\Mux1~0_combout\)) # (!\Add0~6\))
...
-- Equation(s):
-- \Add1~26_combout\ = (\i_OpSel[1]~input_o\ & (\Mult0|auto_generated|mac_out2~DATAOUT7\)) # (!\i_OpSel[1]~input_o\ & ((\Add1~6_combout\)))
...
-- Equation(s):
-- \Add1~24_combout\ = (\i_OpSel[1]~input_o\ & (\Mult0|auto_generated|mac_out2~DATAOUT5\)) # (!\i_OpSel[1]~input_o\ & ((\Add1~2_combout\)))
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder3|Mux6~0_combout\ = (\Add1~25_combout\ & (!\Add1~24_combout\ & (\Add1~23_combout\ $ (!\Add1~26_combout\)))) # (!\Add1~25_combout\ & (\Add1~23_combout\ & (\Add1~26_combout\ $ (!\Add1~24_combout\))))
...
-- Equation(s):
-- \Add0~9_combout\ = (\Add0~8\ & ((\i_NumB[4]~input_o\ $ (\Mux1~0_combout\)))) # (!\Add0~8\ & (\i_NumB[4]~input_o\ $ (\Mux1~0_combout\ $ (VCC))))
-- \Add0~10\ = CARRY((!\Add0~8\ & (\i_NumB[4]~input_o\ $ (\Mux1~0_combout\))))
...
-- Equation(s):
-- \Add0~11_combout\ = (\Add0~10\ & (\i_NumB[5]~input_o\ $ ((!\Mux1~0_combout\)))) # (!\Add0~10\ & ((\i_NumB[5]~input_o\ $ (\Mux1~0_combout\)) # (GND)))
-- \Add0~12\ = CARRY((\i_NumB[5]~input_o\ $ (!\Mux1~0_combout\)) # (!\Add0~10\))
...
-- Equation(s):
-- \Add0~13_combout\ = (\Add0~12\ & ((\i_NumB[6]~input_o\ $ (\Mux1~0_combout\)))) # (!\Add0~12\ & (\i_NumB[6]~input_o\ $ (\Mux1~0_combout\ $ (VCC))))
-- \Add0~14\ = CARRY((!\Add0~12\ & (\i_NumB[6]~input_o\ $ (\Mux1~0_combout\))))
...
-- Equation(s):
-- \Add1~10_combout\ = (\Add0~11_combout\ & ((\i_NumA[5]~input_o\ & (\Add1~9\ & VCC)) # (!\i_NumA[5]~input_o\ & (!\Add1~9\)))) # (!\Add0~11_combout\ & ((\i_NumA[5]~input_o\ & (!\Add1~9\)) # (!\i_NumA[5]~input_o\ & ((\Add1~9\) # (GND)))))
-- \Add1~11\ = CARRY((\Add0~11_combout\ & (!\i_NumA[5]~input_o\ & !\Add1~9\)) # (!\Add0~11_combout\ & ((!\Add1~9\) # (!\i_NumA[5]~input_o\))))
...
-- Equation(s):
-- \Add1~12_combout\ = ((\i_NumA[6]~input_o\ $ (\Add0~13_combout\ $ (!\Add1~11\)))) # (GND)
-- \Add1~13\ = CARRY((\i_NumA[6]~input_o\ & ((\Add0~13_combout\) # (!\Add1~11\))) # (!\i_NumA[6]~input_o\ & (\Add0~13_combout\ & !\Add1~11\)))
...
-- Equation(s):
-- \Add1~21_combout\ = (\i_OpSel[1]~input_o\ & ((\Mult0|auto_generated|mac_out2~DATAOUT10\))) # (!\i_OpSel[1]~input_o\ & (\Add1~12_combout\))
...
-- Equation(s):
-- \Add1~20_combout\ = (\i_OpSel[1]~input_o\ & (\Mult0|auto_generated|mac_out2~DATAOUT9\)) # (!\i_OpSel[1]~input_o\ & ((\Add1~10_combout\)))
...
-- Equation(s):
-- \Add0~15_combout\ = \i_NumB[7]~input_o\ $ (\Add0~14\ $ (\Mux1~0_combout\))
...
-- Equation(s):
-- \Add1~22_combout\ = (\i_OpSel[1]~input_o\ & (\Mult0|auto_generated|mac_out2~DATAOUT11\)) # (!\i_OpSel[1]~input_o\ & ((\Add1~14_combout\)))
...
-- Equation(s):
-- \Add1~19_combout\ = (\i_OpSel[1]~input_o\ & ((\Mult0|auto_generated|mac_out2~DATAOUT8\))) # (!\i_OpSel[1]~input_o\ & (\Add1~8_combout\))
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder2|Mux6~0_combout\ = (\Add1~21_combout\ & (!\Add1~20_combout\ & (\Add1~22_combout\ $ (!\Add1~19_combout\)))) # (!\Add1~21_combout\ & (\Add1~19_combout\ & (\Add1~20_combout\ $ (!\Add1~22_combout\))))
...
-- Equation(s):
-- \Mux4~0_combout\ = (\Mult0|auto_generated|mac_out2~DATAOUT13\ & \i_OpSel[1]~input_o\)
...
-- Equation(s):
-- \Mux2~0_combout\ = (\i_OpSel[1]~input_o\ & \Mult0|auto_generated|mac_out2~DATAOUT15\)
...
-- Equation(s):
-- \Mux3~0_combout\ = (\i_OpSel[1]~input_o\ & \Mult0|auto_generated|mac_out2~DATAOUT14\)
...
-- Equation(s):
-- \Add1~18_combout\ = (\i_OpSel[1]~input_o\ & (\Mult0|auto_generated|mac_out2~DATAOUT12\)) # (!\i_OpSel[1]~input_o\ & ((\Add1~16_combout\)))
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder1|Mux6~0_combout\ = (\Mux2~0_combout\ & (\Add1~18_combout\ & (\Mux4~0_combout\ $ (\Mux3~0_combout\)))) # (!\Mux2~0_combout\ & (!\Mux4~0_combout\ & (\Mux3~0_combout\ $ (\Add1~18_combout\))))
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder4|Mux6~3_combout\ = (\i_OpSel[1]~input_o\ & \DisplayDriver|DisplayDecoder4|Mux6~2_combout\)
...
PORT MAP (
	datab => \i_OpSel[1]~input_o\,
	datac => \DisplayDriver|DisplayDecoder4|Mux6~2_combout\,
	combout => \DisplayDriver|DisplayDecoder4|Mux6~3_combout\);

-- Location: LCCOMB_X18_Y8_N4
\DisplayDriver|Mux10~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \DisplayDriver|Mux10~1_combout\ = (\DisplayDriver|Mux10~0_combout\ & ((\DisplayDriver|DisplayDecoder3|Mux6~0_combout\) # ((\DisplayDriver|r_Sel\(1))))) # (!\DisplayDriver|Mux10~0_combout\ & (((!\DisplayDriver|r_Sel\(1) & 
...
PORT MAP (
	...
	datac => \DisplayDriver|r_Sel\(1),
	datad => \DisplayDriver|DisplayDecoder4|Mux6~3_combout\,
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder2|Mux5~0_combout\ = (\Add1~20_combout\ & ((\Add1~19_combout\ & ((\Add1~22_combout\))) # (!\Add1~19_combout\ & (\Add1~21_combout\)))) # (!\Add1~20_combout\ & (\Add1~21_combout\ & (\Add1~22_combout\ $ (\Add1~19_combout\))))
...
-- pragma translate_on
PORT MAP (
	datab => \DisplayDriver|DisplayDecoder4|Mux5~2_combout\,
	datac => \i_OpSel[1]~input_o\,
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder1|Mux5~0_combout\ = (\Mux4~0_combout\ & ((\Add1~18_combout\ & (\Mux2~0_combout\)) # (!\Add1~18_combout\ & ((\Mux3~0_combout\))))) # (!\Mux4~0_combout\ & (\Mux3~0_combout\ & (\Mux2~0_combout\ $ (\Add1~18_combout\))))
...
-- Equation(s):
-- \DisplayDriver|Mux9~0_combout\ = (\DisplayDriver|r_Sel\(1) & (((\DisplayDriver|r_Sel\(0) & \DisplayDriver|DisplayDecoder1|Mux5~0_combout\)))) # (!\DisplayDriver|r_Sel\(1) & ((\DisplayDriver|DisplayDecoder4|Mux5~3_combout\) # ((\DisplayDriver|r_Sel\(0)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \DisplayDriver|DisplayDecoder4|Mux5~3_combout\,
	datab => \DisplayDriver|r_Sel\(1),
	datac => \DisplayDriver|r_Sel\(0),
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder3|Mux5~0_combout\ = (\Add1~26_combout\ & ((\Add1~23_combout\ & ((\Add1~24_combout\))) # (!\Add1~23_combout\ & (\Add1~25_combout\)))) # (!\Add1~26_combout\ & (\Add1~25_combout\ & (\Add1~23_combout\ $ (\Add1~24_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \DisplayDriver|Mux10~2_combout\,
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder3|Mux4~0_combout\ = (\Add1~25_combout\ & (\Add1~26_combout\ & ((\Add1~24_combout\) # (!\Add1~23_combout\)))) # (!\Add1~25_combout\ & (!\Add1~23_combout\ & (!\Add1~26_combout\ & \Add1~24_combout\)))
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder1|Mux4~0_combout\ = (\Mux2~0_combout\ & (\Mux3~0_combout\ & ((\Mux4~0_combout\) # (!\Add1~18_combout\)))) # (!\Mux2~0_combout\ & (!\Mux3~0_combout\ & (!\Add1~18_combout\ & \Mux4~0_combout\)))
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder2|Mux4~0_combout\ = (\Add1~21_combout\ & (\Add1~22_combout\ & ((\Add1~20_combout\) # (!\Add1~19_combout\)))) # (!\Add1~21_combout\ & (\Add1~20_combout\ & (!\Add1~22_combout\ & !\Add1~19_combout\)))
...
PORT MAP (
	...
	datac => \DisplayDriver|DisplayDecoder1|Mux4~0_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \DisplayDriver|DisplayDecoder4|Mux4~2_combout\,
	datac => \i_OpSel[1]~input_o\,
...
-- Equation(s):
-- \DisplayDriver|Mux8~1_combout\ = (\DisplayDriver|Mux8~0_combout\ & ((\DisplayDriver|DisplayDecoder3|Mux4~0_combout\) # ((\DisplayDriver|r_Sel\(1))))) # (!\DisplayDriver|Mux8~0_combout\ & (((\DisplayDriver|DisplayDecoder4|Mux4~3_combout\ & 
...
PORT MAP (
	...
	datac => \DisplayDriver|DisplayDecoder4|Mux4~3_combout\,
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder1|Mux3~0_combout\ = (\Add1~18_combout\ & (\Mux4~0_combout\ $ (((!\Mux3~0_combout\))))) # (!\Add1~18_combout\ & ((\Mux4~0_combout\ & (\Mux2~0_combout\ & !\Mux3~0_combout\)) # (!\Mux4~0_combout\ & (!\Mux2~0_combout\ & 
-- \Mux3~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	datab => \DisplayDriver|DisplayDecoder4|Mux3~2_combout\,
	datac => \i_OpSel[1]~input_o\,
...
-- Equation(s):
-- \DisplayDriver|Mux7~0_combout\ = (\DisplayDriver|r_Sel\(1) & (\DisplayDriver|DisplayDecoder1|Mux3~0_combout\ & (\DisplayDriver|r_Sel\(0)))) # (!\DisplayDriver|r_Sel\(1) & (((\DisplayDriver|r_Sel\(0)) # (\DisplayDriver|DisplayDecoder4|Mux3~3_combout\))))
...
PORT MAP (
	...
	datab => \DisplayDriver|r_Sel\(1),
	datac => \DisplayDriver|r_Sel\(0),
	datad => \DisplayDriver|DisplayDecoder4|Mux3~3_combout\,
	combout => \DisplayDriver|Mux7~0_combout\);

-- Location: LCCOMB_X18_Y8_N8
\DisplayDriver|DisplayDecoder3|Mux3~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \DisplayDriver|DisplayDecoder3|Mux3~0_combout\ = (\Add1~23_combout\ & (\Add1~25_combout\ $ (((!\Add1~24_combout\))))) # (!\Add1~23_combout\ & ((\Add1~25_combout\ & (!\Add1~26_combout\ & !\Add1~24_combout\)) # (!\Add1~25_combout\ & (\Add1~26_combout\ & 
-- \Add1~24_combout\))))
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder2|Mux3~0_combout\ = (\Add1~19_combout\ & (\Add1~21_combout\ $ ((!\Add1~20_combout\)))) # (!\Add1~19_combout\ & ((\Add1~21_combout\ & (!\Add1~20_combout\ & !\Add1~22_combout\)) # (!\Add1~21_combout\ & (\Add1~20_combout\ & 
-- \Add1~22_combout\))))
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder3|Mux2~0_combout\ = (\Add1~24_combout\ & (\Add1~23_combout\ & ((!\Add1~26_combout\)))) # (!\Add1~24_combout\ & ((\Add1~25_combout\ & ((!\Add1~26_combout\))) # (!\Add1~25_combout\ & (\Add1~23_combout\))))
...
-- pragma translate_on
PORT MAP (
	datab => \DisplayDriver|DisplayDecoder4|Mux2~2_combout\,
	datac => \i_OpSel[1]~input_o\,
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder2|Mux2~0_combout\ = (\Add1~20_combout\ & (((!\Add1~22_combout\ & \Add1~19_combout\)))) # (!\Add1~20_combout\ & ((\Add1~21_combout\ & (!\Add1~22_combout\)) # (!\Add1~21_combout\ & ((\Add1~19_combout\)))))
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder1|Mux2~0_combout\ = (\Mux4~0_combout\ & (!\Mux2~0_combout\ & ((\Add1~18_combout\)))) # (!\Mux4~0_combout\ & ((\Mux3~0_combout\ & (!\Mux2~0_combout\)) # (!\Mux3~0_combout\ & ((\Add1~18_combout\)))))
...
-- ((\DisplayDriver|DisplayDecoder4|Mux2~3_combout\)))))
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder3|Mux1~0_combout\ = (\Add1~23_combout\ & (\Add1~26_combout\ $ (((\Add1~24_combout\) # (!\Add1~25_combout\))))) # (!\Add1~23_combout\ & (!\Add1~25_combout\ & (!\Add1~26_combout\ & \Add1~24_combout\)))
...
-- pragma translate_on
PORT MAP (
	datab => \DisplayDriver|DisplayDecoder4|Mux1~2_combout\,
	datac => \i_OpSel[1]~input_o\,
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder1|Mux1~0_combout\ = (\Mux4~0_combout\ & (!\Mux2~0_combout\ & ((\Add1~18_combout\) # (!\Mux3~0_combout\)))) # (!\Mux4~0_combout\ & (\Add1~18_combout\ & (\Mux2~0_combout\ $ (!\Mux3~0_combout\))))
...
-- Equation(s):
-- \DisplayDriver|Mux5~0_combout\ = (\DisplayDriver|r_Sel\(1) & (((\DisplayDriver|r_Sel\(0) & \DisplayDriver|DisplayDecoder1|Mux1~0_combout\)))) # (!\DisplayDriver|r_Sel\(1) & ((\DisplayDriver|DisplayDecoder4|Mux1~3_combout\) # ((\DisplayDriver|r_Sel\(0)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \DisplayDriver|DisplayDecoder4|Mux1~3_combout\,
	datab => \DisplayDriver|r_Sel\(1),
	datac => \DisplayDriver|r_Sel\(0),
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder2|Mux1~0_combout\ = (\Add1~21_combout\ & (\Add1~19_combout\ & (\Add1~20_combout\ $ (\Add1~22_combout\)))) # (!\Add1~21_combout\ & (!\Add1~22_combout\ & ((\Add1~20_combout\) # (\Add1~19_combout\))))
...
-- Equation(s):
-- \DisplayDriver|Mux5~1_combout\ = (\DisplayDriver|Mux5~0_combout\ & ((\DisplayDriver|DisplayDecoder3|Mux1~0_combout\) # ((!\DisplayDriver|Mux10~2_combout\)))) # (!\DisplayDriver|Mux5~0_combout\ & (((\DisplayDriver|Mux10~2_combout\ & 
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder4|Mux0~3_combout\ = (\i_OpSel[1]~input_o\ & \DisplayDriver|DisplayDecoder4|Mux0~2_combout\)
...
PORT MAP (
	datab => \i_OpSel[1]~input_o\,
	datac => \DisplayDriver|DisplayDecoder4|Mux0~2_combout\,
	combout => \DisplayDriver|DisplayDecoder4|Mux0~3_combout\);

-- Location: LCCOMB_X18_Y8_N20
\DisplayDriver|DisplayDecoder3|Mux0~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \DisplayDriver|DisplayDecoder3|Mux0~0_combout\ = (\Add1~23_combout\ & ((\Add1~26_combout\) # (\Add1~25_combout\ $ (\Add1~24_combout\)))) # (!\Add1~23_combout\ & ((\Add1~24_combout\) # (\Add1~25_combout\ $ (\Add1~26_combout\))))
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder1|Mux0~0_combout\ = (\Add1~18_combout\ & ((\Mux2~0_combout\) # (\Mux4~0_combout\ $ (\Mux3~0_combout\)))) # (!\Add1~18_combout\ & ((\Mux4~0_combout\) # (\Mux2~0_combout\ $ (\Mux3~0_combout\))))
...
-- Equation(s):
-- \DisplayDriver|DisplayDecoder2|Mux0~0_combout\ = (\Add1~19_combout\ & ((\Add1~22_combout\) # (\Add1~21_combout\ $ (\Add1~20_combout\)))) # (!\Add1~19_combout\ & ((\Add1~20_combout\) # (\Add1~21_combout\ $ (\Add1~22_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \DisplayDriver|DisplayDecoder4|Mux0~3_combout\,
